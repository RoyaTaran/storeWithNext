function handler(req, res) {
  ...
  DataBase.connect(() => {
    ...
    if (req.method === "POST") {
      ...
      const postuserQuery = `INSERT INTO users VALUES (null,"${newuser.token}","${newuser.firstName}","${newuser.lastName}",${newuser.phone},"${newuser.email}","${newuser.password}",${newuser.buy},"${newuser.city}","${newuser.address}")`;
